<?php
/**This file contains the class Query2XMLTestADOdbPEAR.
*
* LICENSE:
...
// Call Query2XMLTestADOdbPEAR::main() if this source file is executed directly.
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "Query2XMLTestADOdbPEAR::main");
}
...
* All tests are run by using PEAR_Error for error handling (adodb-pear.inc.php).
* 
* @author Lukas Feiler <lukas.feiler@lukasfeiler.com>
* @version Release: @package_version@
* @copyright Empowered Media 2006
*/
class Query2XMLTestADOdbPEAR extends PHPUnit2_Framework_TestCase
{
    ...
    */
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("Query2XMLTestADOdbPEAR");
    ...
    public function test_prepareAndExecuteExecuteQueryDBException()
    {
        try {
            ...
            self::assertEquals(                
                ...
                . 'non_existing_table; '
                . '[pear_error: message="'
                . 'mysql error: [1146: Table \'query2xml_tests'
                . '.non_existing_table\' doesn\'t exist] in EXECUTE("SELECT * FROM'
                . ' non_existing_table")'
                . '" code=1146 mode=return level=notice prefix="" info="Table \''
    ...
    public function test_mapSQLIdentifierToXMLNameNotCallableException3()
    {
        try {
            ...
            self::assertEquals(
                '[elements][albums]: The method/function "Query2XMLTestADOdbPEAR::noSuchMethod" specified in the configuration option "mapper" is not callable.',
                $e->getMessage()
            );
        }
    }
...
// Call Query2XMLTestADOdbPEAR::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "Query2XMLTestADOdbPEAR::main") {
    Query2XMLTestADOdbPEAR::main();
}
?>