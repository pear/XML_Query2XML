<?php
/**This file contains the class Query2XMLTestDB.
*
* LICENSE:
...
// Call Query2XMLTestDB::main() if this source file is executed directly.
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "Query2XMLTestDB::main");
}
...
/**Test class for XML_Query2XML that requires PEAR DB.
* 
* @author Lukas Feiler <lukas.feiler@lukasfeiler.com>
* @version Release: @package_version@
* @copyright Empowered Media 2006
*/
class Query2XMLTestDB extends PHPUnit2_Framework_TestCase
{
    ...
    */
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("Query2XMLTestDB");
    ...
    public function test_mapSQLIdentifierToXMLNameNotCallableException3()
    {
        try {
            ...
            self::assertEquals(
                '[elements][albums]: The method/function "Query2XMLTestDB::noSuchMethod" specified in the configuration option "mapper" is not callable.',
                $e->getMessage()
            );
        }
    }
...
// Call Query2XMLTestDB::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "Query2XMLTestDB::main") {
    Query2XMLTestDB::main();
}
?>