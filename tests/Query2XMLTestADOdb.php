<?php
/**This file contains the class Query2XMLTestADOdb.
*
* LICENSE:
...
// Call Query2XMLTestADOdb::main() if this source file is executed directly.
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "Query2XMLTestADOdb::main");
}
...
* All tests are run with the default error handling.
* 
* @author Lukas Feiler <lukas.feiler@lukasfeiler.com>
* @version Release: @package_version@
* @copyright Empowered Media 2006
*/
class Query2XMLTestADOdb extends PHPUnit2_Framework_TestCase
{
    ...
    */
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("Query2XMLTestADOdb");
    ...
    public function test_prepareAndExecuteExecuteQueryDBException()
    {
        try {
            ...
            self::assertEquals(
                'Could not execute the following SQL query; false was returned: SELECT * FROM non_existing_table',
                $e->getMessage()
            );
        }
    }
    ...
    public function test_prepareAndExecuteSimpleQueryDBException()
    {
        try {
            ...
            self::assertEquals(
                'Could not run the following SQL query: SELECT * FROM non_existing_table',
                $e->getMessage()
            );
        }
    }
    ...
    public function test_mapSQLIdentifierToXMLNameNotCallableException3()
    {
        try {
            ...
            self::assertEquals(
                '[elements][albums]: The method/function "Query2XMLTestADOdb::noSuchMethod" specified in the configuration option "mapper" is not callable.',
                $e->getMessage()
            );
        }
    }
...
// Call Query2XMLTestADOdb::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "Query2XMLTestADOdb::main") {
    Query2XMLTestADOdb::main();
}
?>