...
class Query2XMLTest extends PHPUnit2_Framework_TestCase
{
    ...
    */
    ...
    private function _getXMLMDB2($sql, $options)
    {
        $dom = $this->query2xml_mdb2->getXML($sql, $options);
        return $dom->saveXML();
    }
    ...
    public function setUp()
    {
        ...
        $this->query2xml_mdb2 =& XML_Query2XML::factory($mdb2);
    }
...
"]',
    ...
    public function test_prepareAndExecuteExecuteQueryDBException()
    {
        try {
            ...
            self::assertEquals(
                'Could not execute the following SQL query: SELECT * FROM non_existing_table; [db_error: message="DB Error: no such table" code=-18 mode=return level=notice prefix="" info="SELECT * FROM non_existing_table [nativecode=1146 ** Table \'query2xml_tests.non_existing_table\' doesn\'t exist]"]',
                $e->getMessage()
            );
        }
    }
    ...
    public function test_prepareAndExecuteSimpleQueryDBException()
    {
        try {
            ...
            self::assertEquals(
                'Could not run the following SQL query: SELECT * FROM non_existing_table; [db_error: message="DB Error: no such table" code=-18 mode=return level=notice prefix="" info="SELECT * FROM non_existing_table [nativecode=1146 ** Table \'query2xml_tests.non_existing_table\' doesn\'t exist]"]',
                $e->getMessage()
            );
        }
    }
    ...
    public function test_mapSQLIdentifierToXMLNameNotCallableException3()
    {
        try {
            ...
            self::assertEquals(
                '[elements][albums]: The method/function "Query2XMLTest::noSuchMethod" specified in the configuration option "mapper" is not callable.',
                $e->getMessage()
            );
        }
    }
    ...
    public function testGetFlatXML_MDB2()
    {
        $dom =& $this->query2xml_mdb2->getFlatXML('SELECT * FROM album');
        self::assertTrue(md5($dom->saveXML()) === '1235dd9cada59f43cee0f6d0b4829b27');
    }
    
    public function test_createDOMElementException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
                    *
                 FROM
                    artist
    ...
    public function test_prepareAndExecuteExecuteQueryDBException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
...
"]',
    ...
    public function test_prepareAndExecuteSimpleQueryDBException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
...
"]',
    ...
    public function test_applyColumnStringToRecordException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_applySqlOptionsToRecordMergeException2_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_applySqlOptionsToRecordMergeException1_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_applySqlOptionsToRecordWrongDataTypeException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_applySqlOptionsToRecordWrongQueryTypeException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_applySqlOptionsToRecordMissingQueryException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_applySqlOptionsToRecordMergeSelectiveTypeException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_processComplexElementSpecificationRETHROW_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_processComplexAttributeSpecificationMissingValueException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_getNestedXMLRecordAttributesTypeException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_getNestedXMLRecordElementsTypeException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_getNestedXMLRecordIdColumnMissingException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_getNestedXMLRecordInvalidAttributeException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_mapSQLIdentifierToXMLNameNotCallableException_MDB2()
    {
        try {
            $dom =& $this->_getXMLMDB2(
                "SELECT
                    *
                 FROM
                    artist
    ...
    public function test_mapSQLIdentifierToXMLNameNotCallableException2_MDB2()
    {
        try {
            $dom =& $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_mapSQLIdentifierToXMLNameNotCallableException3_MDB2()
    {
        try {
            $dom =& $this->_getXMLMDB2(
                "SELECT
    ...
    public function test_mapSQLIdentifierToXMLNameNotMappable_MDB2()
    {
        try {
            $dom =& $this->_getXMLMDB2(
                "SELECT
    ...
    public function testGetFlatXMLException_MDB2()
    {
        try {
            $dom =& $this->query2xml_mdb2->getFlatXML('SELECT * FROM non_existing_table');
            self::assertTrue(false);
        } catch (XML_Query2XML_DBException $e) {
            //did throw exception
            self::assertTrue(true);
    ...
    public function testGetXMLException_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function testGetXMLExceptionWrongRootTag_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function testGetXMLExceptionWrongRowTag_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function testGetXMLExceptionWrongIdColumn_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function testGetXMLExceptionWrongElementColumnName_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function testGetXMLExceptionWrongElementTagName_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function testGetXMLExceptionWrongSubRootName_MDB2()
    {
        try {
            $xml = $this->_getXMLMDB2(
                "SELECT
    ...
    public function testGetFlatXMLCase1_MDB2()
    {
        $dom =& $this->query2xml_mdb2->getFlatXML("SELECT * FROM artist", 'music_library', 'artist');
        self::assertTrue(md5($dom->saveXML()) === '0c33b7de1a587b4c2b436e7e495f1cf4');
    }
    
    public function testGetXMLCase2_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLCase3_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLCase4_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLCase5_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                 *
    ...
    public function testGetXMLCase6_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                 s.*,
    ...
    public function testGetXMLCase7_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLCase8_MDB2()
    {
        $myMappers = new Mappers();
    ...
    public function testEnableDebugLog_MDB2()
    {
        $debugLogger = new MyLogger();
        $this->query2xml_mdb2->enableDebugLog($debugLogger);
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
             FROM
        ...
        $this->query2xml_mdb2->disableDebugLog();
        self::assertTrue(md5($debugLogger->data) === '712378b7719c26f8c751f8b7f131272f');
    }

    public function testDisableDebugLog_MDB2()
    {
        $debugLogger = new MyLogger();
        $this->query2xml_mdb2->enableDebugLog($debugLogger);
        $this->query2xml_mdb2->disableDebugLog();
    ...
    public function testStartProfiling_MDB2()
    {
        $this->query2xml_mdb2->startProfiling();
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
             FROM
        ...
        self::assertTrue(count($this->query2xml_mdb2->getRawProfile()) == 6);
        $this->query2xml_mdb2->clearProfile();
    }

    public function testStopProfiling_MDB2()
    {
        $this->query2xml_mdb2->startProfiling();
        $this->query2xml_mdb2->stopProfiling();
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
             FROM
        ...
        $profile = $this->query2xml_mdb2->getRawProfile();
        self::assertTrue(count($profile['queries']) === 0);
    }

    public function testClearProfile_MDB2()
    {
        $this->query2xml_mdb2->startProfiling();
        $xml = $this->_getXMLMDB2(
            "SELECT
        ...
        $this->query2xml_mdb2->clearProfile();
        self::assertTrue(count($this->query2xml_mdb2->getRawProfile()) === 0);
    }


    public function testGetRawProfile_MDB2()
    {
        $this->query2xml_mdb2->startProfiling();
        $xml = $this->_getXMLMDB2(
            "SELECT
        ...
        $rawProfile = $this->query2xml_mdb2->getRawProfile();
        self::assertTrue(count($rawProfile['queries']) === 2);
    }
    
    public function testGetProfile_MDB2()
    {
        $this->query2xml_mdb2->startProfiling();
        $xml = $this->_getXMLMDB2(
            "SELECT
        ...
        $profile = $this->query2xml_mdb2->getProfile();
        $selectCount = preg_match_all('/SELECT/', $profile, $matches);
        self::assertTrue($selectCount === 2);
    }
    
    public function testGetXMLCondition_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLCondition2_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLConditionalOperatorInElement1_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLConditionalOperatorInElement2_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLConditionalOperatorInElement3_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                artist.*,
    ...
    public function testGetXMLConditionalOperatorInAttribute1_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                artist.*,
    ...
    public function testGetXMLConditionalOperatorInAttribute2_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                artist.*,
    ...
    public function testGetXMLConditionalOperatorInAttribute3_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                artist.*,
    ...
    public function testGetXMLConditionalOperatorInValue1_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLConditionalOperatorInValue2_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLConditionalOperatorInValue3_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                artist.*,
    ...
    public function testGetXMLElementAsteriskShortcut1_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLElementAsteriskShortcut2_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLElementAsteriskShortcut3_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLElementAsteriskShortcut4_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLElementAsteriskShortcut5_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLAttributeAsteriskShortcut1_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLAttributeAsteriskShortcut2_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLAttributeAsteriskShortcut3_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLAttributeAsteriskShortcut4_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLComplexAttributeSpecification1_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLComplexAttributeSpecification2_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLComplexAttributeSpecification3_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
    ...
    public function testGetXMLComplexAttributeSpecification4_MDB2()
    {
        $xml = $this->_getXMLMDB2(
            "SELECT
                *
